...
ARG NEXT_PUBLIC_STRIPE_YEARLY_PRICE_KEY
ARG NEXT_PUBLIC_STRIPE_MONTHLY_PRICE_KEY
...
ENV NEXT_PUBLIC_STRIPE_YEARLY_PRICE_KEY=$NEXT_PUBLIC_STRIPE_YEARLY_PRICE_KEY
ENV NEXT_PUBLIC_STRIPE_MONTHLY_PRICE_KEY=$NEXT_PUBLIC_STRIPE_MONTHLY_PRICE_KEY
